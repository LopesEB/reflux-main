...
@Injectable()
export class DoramogoProcessorService {
  public constructor(
    @Inject(forwardRef(() => DoramogoProvider))
    private readonly doramogoProvider: DoramogoProvider,
        ...
        for (const chunk of chunks) {
          ...
          const foundStream = await this.prismaService.movie.findFirst({
            where: {
              ...
              streams: {
                some: {
                  provider: this.doramogoProvider.provider,
